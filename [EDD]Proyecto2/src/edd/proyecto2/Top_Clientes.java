 ...
 * @author Casca
 */
public class Top_Clientes extends javax.swing.JFrame {
    private String Para_reporte="";
    /**
     * Creates new form Top_Clientes
     */
    public Top_Clientes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Top de Clientes");
        jPanel4.add(jLabel8);
        jLabel8.setBounds(240, 60, 300, 60);
    ...
    public String contenido(){
        ...
        TopCliente aux = Pantalla_Principal.Top_Clientes.Cabeza;
        ...
        }while(aux!=Pantalla_Principal.Top_Clientes.Cabeza);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Top_Clientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Top_Clientes().setVisible(true);
            }
        });
    }
