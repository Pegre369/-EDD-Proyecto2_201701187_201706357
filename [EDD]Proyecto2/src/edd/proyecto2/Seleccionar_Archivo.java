 ...
 * @author Casca
 */
public class Seleccionar_Archivo extends javax.swing.JFrame {

   public static String ruta;
   
    public Seleccionar_Archivo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Seleccionar_Archivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Seleccionar_Archivo().setVisible(true);
            }
        });
    }
