 ...
 * @author Casca
 */
public class Top_Viajes extends javax.swing.JFrame {
  private String Para_reporte="";
    /**
     * Creates new form Top_Viajes
     */
    public Top_Viajes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Top de Viajes");
        jPanel4.add(jLabel8);
        jLabel8.setBounds(240, 60, 250, 60);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        String mostrar="";
        prubea p = new prubea();
        descomprimido= p.descomprimir("Top_10_Viajes");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
      ...
      public String contenido(){
        ...
        String cuerpo ="";
          ...
          Top_Viaje aux = Pantalla_Principal.Top_Viajes.Cabeza;
        
        Lista_Top_Viaje nueva = new Lista_Top_Viaje();
        
        do{
        
            nueva.insertar(aux.getLlave(), aux.getOrigen(), aux.getDestino(), aux.getLargo());
        
            aux = aux.Siguiente;
            
        }while(aux!=Pantalla_Principal.Top_Viajes.Cabeza);
        
        Top_Viaje aux2  = nueva.Cabeza;
        int cont = 1;
        
        do{
            
            cuerpo = cuerpo + String.valueOf(cont)+" "+aux2.getLlave()+" "+ aux2.getOrigen()+" "+aux2.getDestino()+" "+String.valueOf(aux2.getLargo())+"\n";
            Para_reporte  = Para_reporte + String.valueOf(cont)+"/"+aux2.getLlave()+"/"+ aux2.getOrigen()+"/"+aux2.getDestino()+"/"+String.valueOf(aux2.getLargo())+";";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Top_Viajes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Top_Viajes().setVisible(true);
            }
        });
    }
