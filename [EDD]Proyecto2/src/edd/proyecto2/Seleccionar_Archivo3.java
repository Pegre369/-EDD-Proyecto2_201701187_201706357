 ...
 * @author Steven Sis
 */
public class Seleccionar_Archivo3 extends javax.swing.JFrame {

    /**
     * Creates new form Seleccionar_Archivo3
     */
    public Seleccionar_Archivo3() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Seleccionar_Archivo3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Seleccionar_Archivo3().setVisible(true);
            }
        });
    }
       ...
       String [] datosseparados = respuesta.split(";");
        ...
        for (int i = 0; i < datosseparados.length; i++) {
            ...
            if(datosseparados[i].equals(" ")){
                ...
                Pantalla_Principal.tablaHash.insertar(new BigInteger(datosfinale[0]),datosfinale[1], datosfinale[2], datosfinale[3], datosfinale[4], Integer.valueOf(datosfinale[5]), datosfinale[6] );
