 ...
 * @author Casca
 */
public class Top_Vehiculos extends javax.swing.JFrame {
private String Para_reporte="";
    /**
     * Creates new form Top_Vehiculos
     */
    public Top_Vehiculos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Top de Vehiculos");
        jPanel4.add(jLabel8);
        jLabel8.setBounds(220, 60, 300, 60);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String reporte = "";
        String Nombre = "Top_10_Vehiculos";
...
public String contenido(){
        ...
        Top_Vehiculo aux = Pantalla_Principal.Top_vehiculo.Cabeza;
        
        Lista_Top_Carros nueva = new Lista_Top_Carros();
        
        do{
        
            nueva.insertar(aux.getPlaca(), aux.getModelo(), aux.getMarca(),aux.getCant());
        
            aux = aux.Siguiente;
            
        }while(aux!=Pantalla_Principal.Top_vehiculo.Cabeza);
        
        Top_Vehiculo aux2  = nueva.Cabeza;
        int cont = 1;
        
        do{
            
            cuerpo = cuerpo + String.valueOf(cont)+" "+aux2.getPlaca()+" "+ aux2.getMarca()+" "+aux2.getModelo()+" "+ String.valueOf(aux2.getCant())+"\n";
            Para_reporte  = Para_reporte + String.valueOf(cont)+"/"+aux2.getPlaca()+" "+ aux2.getMarca()+" "+aux2.getModelo()+" "+ String.valueOf(aux2.getCant())+";";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Top_Vehiculos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Top_Vehiculos().setVisible(true);
            }
        });
    }
